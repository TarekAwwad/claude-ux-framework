...
| T3 | Put units and shared qualifiers in the column header instead of repeating them in every cell, and left-align identifier-like numbers (IDs, dates, postal or phone codes) as text rather than right-aligning them as quantities. | findings-tables Pencil and Paper, findings-tables Salesforce; extends D11 | yes: agents repeat the unit in each cell and right-align every digit column, including IDs and dates |
