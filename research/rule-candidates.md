...
| P3 | Design and build empty, loading, and error states for every data-backed view, not just the populated one. | NN/g empty-state | yes: agents render only the populated view with mock data |
